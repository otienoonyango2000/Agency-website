            ...
            <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16'>
                <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                    ...
                    <div className='md:w-2/3 mx-auto'>
                        <div>
                            <p className='md:w-4/5 text-sm text-neutralGey mb-8 leading-7'>
                            ...
                            <p className='text-based text-neutralGrey mb-8'>British Dragon Boat Racing Association</p>
                            <div>
                                <div className='flex items-center gap-8 flex-wrap'>
                                    <img src='/src/assets/logo2.png' alt='img' className='cursor-pointer'/>
                                    <img src='/src/assets/logo3.png' alt='img' className='cursor-pointer'/>
                                    <img src='/src/assets/logo4.png' alt='img' className='cursor-pointer'/>
                                    <img src='/src/assets/logo5.png' alt='img' className='cursor-pointer'/>
                                    <img src='/src/assets/logo6.png' alt='img' className='cursor-pointer'/>
                                    <img src='/src/assets/logo7.png' alt='img' className='cursor-pointer'/>
                                    <img src='/src/assets/logo8.png' alt='img' className='cursor-pointer'/>
